// menu_run demonstrates a complete, reproducible library workflow.
...
void main(){u8 i;tile_example_begin();M_LCDC=0;vram_example_color(1,2,18,14,2);for(i=0;i<80;i++)result[i]=0;__vram_copy(0x8010,dialogue_tiles,128);vram_example_color(1,1,18,15,3);M_LCDC=0x91;menu.x=1;menu.y=2;menu.w=18;menu.h=5;menu.items=choices;menu.count=3;menu.cursor=0;
// example:menu_run:start
result[0]=menu_run(&menu);
// example:menu_run:end
result[1]=menu.cursor;menu.count=0;result[2]=menu_run(&menu);

demo_label(0,"BLOCKING MENU");

...
Raster_Init();
// example:Raster_PushBgWindowScreen:start
Raster_PushBgWindowScreen(0,8,0,24,48,KQ_RASTER_WIN_SHOW);
// example:Raster_PushBgWindowScreen:end

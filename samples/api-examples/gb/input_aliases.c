...
void main() {
    ...
    while (1) {
        ...
        // example:btn_down:start
        if (btn_down(BTN_A)!=0) held_ticks++;
        // example:btn_down:end
        // example:btn_pressed:start
        ...
        // example:btn_pressed:end
        // example:btn_repeat:start
        ...
        // example:btn_repeat:end
        // example:btn_released:start
    ...
    m_wait(); input_update();
    if (btn_released(BTN_A)!=0 || input_previous()!=0) failures++;

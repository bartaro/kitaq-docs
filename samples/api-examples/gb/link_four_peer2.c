// LINK4 PEER 2: inspect the displayed values and the matching endpoint.
#include "gb_link_example.h"
#pragma bank 0
void main(){u8 i;u8 value;u8 other;u8 slot;u8 cmd;u8 len;u8 data[24];lesson_begin();

result[0]=Link4_InitPeer(2,4);result[1]=Link4_GetMode();result[2]=Link4_GetLocalSlot();result[3]=Link4_GetSlotCount();result[4]=Link4_GetSelectedPeer();
result[5]=Link4_BeginTransferTo(0,162);
...
m_wait();M_LCDC=0;m_text(1,0,"LINK4 PEER 2");

...
void main() {
    ...
    // These helpers accept an 8-bit count. Prepare the shared latch explicitly.
    ...
    // example:pair_nes_ppu_seek:start
    ...
    label(1,22,"PREPARE LATCH BEFORE CALL");

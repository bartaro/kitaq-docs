...
#include "fc_common.h"
#include "ppu.h" // Declarations alone do not supply callable implementations.
...
void main() {
    ...
    __ppu_off();__ppu_ctrl_set(0); // Also disable NMI for this bulk preparation.
    ...
    label(1,22,"DECLARATIONS NEED BODIES");

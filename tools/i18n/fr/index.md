...
Cette édition repose sur la **copie locale des sources du 14 septembre 2026**. Le terme « dernière version » désigne cette copie ; il ne signifie pas que les modifications ultérieures de GitHub sont suivies automatiquement. L'inventaire de référence conserve les empreintes des sources et des exécutables. Les anciennes affirmations de compatibilité ou de validation présentes dans les README ne constituent pas automatiquement des garanties actuelles.

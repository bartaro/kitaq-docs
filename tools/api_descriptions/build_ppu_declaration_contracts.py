"""Document declaration-only PPU names with explicitly tested alternatives."""
...
header=REPOS/'kitaqfc/lib/ppu.h';implementation=header
...
for name,(purpose,args,returns) in rows.items():
    ...
    record['definition']=None;record['availability']='declaration';record.pop('implementation_excerpt',None)
...
print('Four PPU declarations documented with rejected-call builds and executed alternatives.')

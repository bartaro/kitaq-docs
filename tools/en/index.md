...
This edition describes the **source snapshot of September 14, 2026**. The reference inventory records source and executable hashes. Consult the verification records for the inputs, conditions and scope of each test.

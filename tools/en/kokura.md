...
## 1. What KOKURA does
KOKURA emulates GB/CGB software and records observations of pictures, audio, CPU execution, memory, banks, input and diagnostic events. The command-line executable is `kokura-cli.exe`.

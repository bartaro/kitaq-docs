...
__prg_rom u8 route_song[]={AUDIO_CMD_SET_INST,AUDIO_STREAM_CHANNEL_CH4,0,0xC0,AUDIO_CMD_SET_CH3_LEVEL,0x20,AUDIO_CMD_NOTE,AUDIO_STREAM_CHANNEL_CH4,0x35,AUDIO_CMD_WAIT,30,AUDIO_CMD_STOP_CHANNEL,AUDIO_STREAM_CHANNEL_CH4,AUDIO_CMD_WAIT,90,AUDIO_CMD_STOP};
void main() {
    u8 i;
    sound_begin("CH4 STREAM");
    __asm { DI }

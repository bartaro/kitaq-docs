...
__prg_rom u8 route_song[]={30,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,33,AUDIO_VBLANK_REST,90,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,AUDIO_VBLANK_STOP,AUDIO_VBLANK_REST,AUDIO_VBLANK_END};
void main() {
    u8 i;
    sound_begin("CH3 VBLANK-DIRECT");
    __asm { DI }
    ...
    Audio_NoiseEffectActive=0;AudioVBlank_Init();AudioVBlank_Ch1Envelope=0xC0;AudioVBlank_Ch2Envelope=0xC0;AudioVBlank_Ch3Level=0x20;AudioVBlank_Ch4Envelope=0xC0;AudioVBlank_PlayMusic(route_song);AudioVBlank_EnableIrq();
    sound_wait(10);

...
__prg_rom u8 route_song[]={30,33,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,90,AUDIO_VBLANK_STOP,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,AUDIO_VBLANK_END};
void main() {
    u8 i;
    sound_begin("CH1 VBLANK-DIRECT");
    __asm { DI }

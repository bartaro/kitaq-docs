...
__prg_rom u8 route_song[]={30,AUDIO_VBLANK_REST,33,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,90,AUDIO_VBLANK_REST,AUDIO_VBLANK_STOP,AUDIO_VBLANK_REST,AUDIO_VBLANK_REST,AUDIO_VBLANK_END};
void main() {
    u8 i;
    sound_begin("CH2 VBLANK-DIRECT");
    __asm { DI }

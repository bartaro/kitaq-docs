...
__prg_rom u8 route_song[]={AUDIO_CMD_SET_INST,AUDIO_STREAM_CHANNEL_CH3,0,0xC0,AUDIO_CMD_SET_CH3_LEVEL,0x20,AUDIO_CMD_NOTE,AUDIO_STREAM_CHANNEL_CH3,33,AUDIO_CMD_WAIT,30,AUDIO_CMD_STOP_CHANNEL,AUDIO_STREAM_CHANNEL_CH3,AUDIO_CMD_WAIT,90,AUDIO_CMD_STOP};
void main() {
    u8 i;
    sound_begin("CH3 STREAM");
    __asm { DI }

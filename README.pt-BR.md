...
2. Envie juntos `index.html`, os sete volumes, `verification.html`, as pastas de idiomas, `assets`, `samples`, `reference`, `verification`, os READMEs e os avisos de licença. Inclua `.nojekyll`.
